...
Current tasks are available on the repository's *Projects* tab. Check out if there is anything that you can contribute!
...
> You must never report security related issues, vulnerabilities or bugs including sensitive information to the issue tracker, or elsewhere in public. Instead sensitive bugs must be sent by email to <alfredo.hernandez@ug.uchile.cl>.
...
This section guides you through submitting an enhancement suggestion for Metaspread, **including completely new features and minor improvements to existing functionality**. Following these guidelines will help maintainers and the community to understand your suggestion and find related suggestions.
...
- **Explain why this enhancement would be useful** to most Metaspread users. You may also want to point out the other projects that solved it better and which could serve as inspiration.
...
For contributing, you can fork the project, make your changes, and create a pull request (PR). For more information please [click here]https://docs.github.com/en/get-started/exploring-projects-on-github/contributing-to-a-project. If accepted, you will be added to the contributors!
